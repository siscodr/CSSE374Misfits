...
The design of our system is as simple as it can be.  It is made of only four classes.  The main class, DesignParser contains instances of each of the other three classes.  These classes each have a specific functionality.  The ClassMethodVisitor finds the methods within the given set of code.  The ClassFieldVisitor determines whether the classes and variables are private, public or protected. The ClassDeclarationVisitor finds the interfaces and super classes of the given code.  Together, these four classes work together to read in code and create text that can draw a UML diagram for that code with the use of the proper tool.
...
Jonathon Soulsby: added arrows to ClassMethodVisitor, wrote a function to deal with troublesome characters, wrote code to handle <>
