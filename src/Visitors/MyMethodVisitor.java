...
import SDClasses.MethodInstruction;
import SDClasses.SDArrows;
import SDClasses.TypeInstruction;
...
public class MyMethodVisitor extends MethodVisitor {
	...
	// // Unnecessary for our implementation
	// @Override
	// public AnnotationVisitor visitInsnAnnotation(int typeRef, TypePath
	...
	// // Unnecessary for our implementation
	// @Override
	// public AnnotationVisitor visitParameterAnnotation(int parameter, String
	...
	// // Unnecessary for our implementation
	// @Override
	// public AnnotationVisitor visitTryCatchAnnotation(int typeRef, TypePath
	// typePath, String desc, boolean visible) {
